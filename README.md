...
- Select Quick Setup and select VPC with 3 subnets. If you choose to create VPC, CloudFormation template provisiones properly-configured VPC with necessary VPC endpoints. 
...
2.	Deploy provided CloudFormation Templates: [StackSMUSDataSources.yaml](cloudformation/StackSMUSDataSources.yaml) and specify parameters. If you have not created VPC as part of Domain setup, then run [StackSMUSVPCEndpoints.yaml](cloudformation/StackSMUSVPCEndpoints.yaml) to create necessary VPC Endpoints.
